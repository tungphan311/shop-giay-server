...
namespace shop_giay_server.Migrations
{
    ...
    [Migration("20200708052518_Add_OrderAddressId")]
    partial class Add_OrderAddressId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("shop_giay_server.models.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("BeginDelivery")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("shop_giay_server.models.Order", b =>
                {
                    b.HasOne("shop_giay_server.models.Address", null)
                        .WithMany("Orders")
