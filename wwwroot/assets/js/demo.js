...
let dailySalesChart = document
  .getElementById("dailySalesChart")
  .getContext("2d");

let myDailySalesChart = new Chart(dailySalesChart, {
  type: "line",
  data: {
    labels: [
      "January",
...
let topProductsChart = document
  .getElementById("topProductsChart")
  .getContext("2d");

let myTopProductsChart = new Chart(topProductsChart, {
  type: "line",
  data: {
    labels: [
      "January",
